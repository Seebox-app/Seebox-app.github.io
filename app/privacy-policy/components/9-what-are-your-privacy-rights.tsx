export const WhatAreYourPrivacyRights = () => {
  return (
    <div className="space-y-6 text-gray-800">
      <h1 className="text-2xl font-bold" id="9-what-are-your-privacy-rights">
      ...
      <p>
        ...
        email us at{" "}
        <a className="text-blue-600 underline" href="mailto:privacy@seebox.app">
          privacy@seebox.app
        </a>
        .
      </p>
